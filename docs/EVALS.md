...
- Lensfun inspection searches and fingerprints every bundled XML file, including third-party lens files; the aggregate fingerprint must remain unchanged during development.
