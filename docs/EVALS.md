...
- The accepted RawTherapee output ICC path/hash remains unchanged through manifest publication and is the fingerprint recorded in the manifest tool snapshot.
